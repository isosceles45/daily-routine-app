...
class ApiException implements Exception {
  ...
  bool get isRetryable => switch (kind) {
        ApiErrorKind.offline || ApiErrorKind.timeout || ApiErrorKind.unknown => true,
  ...
  factory ApiException.fromDio(DioException e) {
    ...
    return switch (e.type) {
      DioExceptionType.connectionError => ApiException(
          ApiErrorKind.offline, 'Connection failed: ${e.message}', uri: uri),
      DioExceptionType.connectionTimeout ||
      DioExceptionType.receiveTimeout ||
      DioExceptionType.sendTimeout ||
      DioExceptionType.transformTimeout =>
        ApiException(ApiErrorKind.timeout, 'Timed out: ${e.message}', uri: uri),
      ...
      DioExceptionType.badCertificate =>
        ApiException(ApiErrorKind.http, 'Bad certificate', uri: uri),
      DioExceptionType.cancel =>
        ApiException(ApiErrorKind.unknown, 'Cancelled', uri: uri),
