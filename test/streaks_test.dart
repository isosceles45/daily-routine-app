...
void main() {
  group('current', () {
    ...
    test('future dates do not extend the streak', () {
      expect(StreakCalculator.current({'2026-08-26', '2026-08-27'}, today), 1);
    });

    test('crosses month and year boundaries', () {
      expect(
        StreakCalculator.current({'2026-07-31', '2026-08-01'}, '2026-08-01'),
        2,
      );
      expect(
        StreakCalculator.current({'2026-12-31', '2027-01-01'}, '2027-01-01'),
        2,
      );
    });
  });
  ...
  group('longest', () {
    ...
    test('is order-independent', () {
      expect(
        StreakCalculator.longest({'2026-08-03', '2026-08-01', '2026-08-02'}),
        3,
      );
    });
